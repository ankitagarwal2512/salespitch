...
DECKS.studio = {
  ...
  { id:'how', label:'How It Works', icon:'M4 2.5L2 7l2 4.5M10 2.5l2 4.5-2 4.5',
    slides:[
  ...
  { id:'usecases', label:'Use Cases', icon:'M1 4l6-3 6 3-6 3-6-3M1 8l6 3 6-3M1 11l6 3 6-3',
    slides:[
      ...
      { n:16, t:'Uniform Management',             f:'studio-uc-uniform.html', optional:true },
      { n:17, t:'Stationery Management',          f:'studio-uc-stationery.html', optional:true },
      { n:18, t:'Canteen Management',             f:'studio-uc-canteen.html', optional:true },
      { n:19, t:'Seating Management',             f:'studio-uc-seating.html', optional:true },
      { n:20, t:'Leave, Short Leave & On-Duty',   f:'studio-uc-leave.html', optional:true },
      { n:21, t:'Overtime Requests',              f:'studio-uc-overtime.html', optional:true },
      { n:22, t:'OJT Feedback',                   f:'studio-uc-ojt.html', optional:true },
      { n:23, t:'Attendance Kiosk',               f:'studio-uc-kiosk.html', optional:true },
      { n:24, t:'Vendor & Hawker Management',     f:'studio-uc-vendor.html', optional:true },
      { n:25, t:'Production & Delivery Tracking', f:'studio-uc-production.html', optional:true },
      { n:26, t:'Project Feedback',               f:'studio-uc-project.html', optional:true },
    ]},
